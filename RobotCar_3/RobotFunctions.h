...
{  
   ...
   delay(100);
   analogWrite(motorVpwm_,110);
   analogWrite(motorHpwm_,110);
   delay(100);
   analogWrite(motorVpwm_,90);
   analogWrite(motorHpwm_,90);
   delay(100);
   analogWrite(motorVpwm_,70);
   analogWrite(motorHpwm_,70);
   delay(100);
   ...
   delay(100);
   analogWrite(motorVpwm_,10);
   analogWrite(motorHpwm_,10);
   delay(100);
   analogWrite(motorVpwm_,0);
   analogWrite(motorHpwm_,0);
}
